...
def test_submit_summary(aggregator, mocked_prometheus_check, mocked_prometheus_scraper_config):
    ...
    aggregator.assert_metric('prometheus.custom.summary.count', 24547.0, tags=['quantile:0.5'], count=1)
    aggregator.assert_metric('prometheus.custom.summary.count', 25763.0, tags=['quantile:0.9'], count=1)
    aggregator.assert_metric('prometheus.custom.summary.count', 25763.0, tags=['quantile:0.99'], count=1)
    aggregator.assert_all_metrics_covered()
